...
DECLARE @start_time DATETIME, @end_time DATETIME, @batch_start_time DATETIME, @batch_end_time DATETIME
	SET @batch_start_time = GETDATE();
		BEGIN TRY
			...
			PRINT '>>Inserting the Table: silver.crm_cust_info';
			...
			*,
			...
			SET @start_time = GETDATE();
			PRINT '>>Truncating the Table: silver.silver.crm_prd_info';
			TRUNCATE TABLE silver.crm_prd_info;
			PRINT '>>Inserting the Table: silver.crm_prd_info';
			...
			SELECT 
			prd_id, 
			TRIM(REPLACE(SUBSTRING(prd_key,1,5),'-','_')) AS cat_id,-- Extract category id
			TRIM(REPLACE(SUBSTRING(prd_key,7,LEN(prd_key)),'_','-')) AS prd_key, -- Extract product id
			prd_nm,
			...
			PRINT '>>Inserting the Table: silver.crm_sales_details';
			...
			PRINT '>>Inserting the Table: silver.erp_cust_az12';
			...
			PRINT '>>Inserting the Table: silver.erp_loc_a101';
